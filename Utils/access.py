...
def measure_dirs(dirA, dirB, verbose=False):
    if verbose:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default='/media/mmsys99/034e16a1-9515-47f6-bd4a-8fae0e36eccc/SXY/Data/LOL-v1/test/output/base', type=str)
    parser.add_argument('-dirB', default='/media/mmsys99/034e16a1-9515-47f6-bd4a-8fae0e36eccc/SXY/Data/LOL-v1/test/high', type=str)
    ...
    if len(dirA) > 0 and len(dirB) > 0:
        measure_dirs(dirA, dirB, verbose=True)
